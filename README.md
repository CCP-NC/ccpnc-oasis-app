...
NOMAD Oasis app for customising gui elements in the CCPNC NOMAD Oasis database.
...
```sh
git clone https://github.com/Sathya-S3/ccpnc-oasis-app.git
cd ccpnc-oasis-app
...
| Name | E-mail     |
|------|------------|
| Sathya Sai Seetharaman | [sathya-sai.seetharaman@stfc.ac.uk](mailto:sathya-sai.seetharaman@stfc.ac.uk)
